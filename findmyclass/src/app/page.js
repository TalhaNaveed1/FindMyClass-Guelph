...
export default function Page() {
  return (
    <main className="flex justify-center items-center min-h-screen bg-johnston bg-cover bg-center w-full">
      <div className="flex flex-col justify-center items-center text-center">
        ...
        <input type="text" className="p-3 w-96 h-16 rounded-xl" placeholder="Enter a class..." />
