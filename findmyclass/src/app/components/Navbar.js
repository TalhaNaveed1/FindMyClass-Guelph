        ...
        <div className="bg-black pt-6 pb-6">
            <nav className="flex flex-row justify-between">
                ...
                <div className="flex flex-row justify-around">
                    <button className="text-yellow-300 border-yellow-300 font-sans border-2 rounded p-2 pr-3 pl-3 mr-5 font-semibold">Sign up</button>
                    <button className="text-red-600 font-sans mr-5 border-2 rounded p-2 pr-3 pl-3 border-red-600 font-semibold">Sign in</button>
                </div>
            </nav>
        </div>
    );
